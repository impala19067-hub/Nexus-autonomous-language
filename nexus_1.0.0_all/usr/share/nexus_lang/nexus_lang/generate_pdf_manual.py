"""
Nexus Programming Language Manual PDF Generator
Generates: Nexus_Language_Specification_and_Automation_Manual.pdf
"""
import sys
import os
...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        # Header
        self.drawString(54, 750, "NEXUS PROGRAMMING LANGUAGE — SPECIFICATION & AUTOMATION MANUAL")
        ...
        self.drawString(54, 32, "Confidential & Proprietary — Nexus Core Architecture")
...
def build_pdf(filename: str):
    ...
    # ================= COVER BANNER =================
    cover_data = [
        [Paragraph("NEXUS PROGRAMMING LANGUAGE", title_style)],
    ...
    exec_text = (
        "<b>Nexus</b> is designed to solve the critical friction points of modern programming languages. "
        ...
        "<b>Why Nexus is 2X Advanced & Convenient:</b>"
    )
    ...
    syntax_intro = (
        "Nexus combines Pythonic clean syntax with C/Rust-style brace scoping. Expressions support string interpolation, "
    ...
    proc_desc = (
        "In Nexus, process execution is elevated to a first-class language feature. Commands prefixed with <code>$</code> "
    ...
    # ================= CLI TOOLCHAIN =================
    story.append(Paragraph("6. Nexus CLI Executable & REPL Toolchain", h1_style))
    story.append(HRFlowable(width="100%", thickness=1.5, color=SECONDARY, spaceAfter=10))

    cli_info = (
        "Nexus comes with a unified Command Line Interface toolchain supporting file execution, REPL shell interaction, "
        "and direct evaluation:<br/>"
        "• <b>Run Script File:</b> <code>python -m src.cli run script.nx</code><br/>"
...
if __name__ == '__main__':
    target_pdf = os.path.abspath("Nexus_Language_Specification_and_Automation_Manual.pdf")
