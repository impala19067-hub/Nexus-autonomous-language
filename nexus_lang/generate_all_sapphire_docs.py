...
1. Nexus_Coding_and_Usage_Guide.pdf / Sapphire_Coding_and_Usage_Guide.pdf
2. Building_Advanced_Autonomous_AI.pdf
3. Nexus_Autonomy_and_Performance_Benchmarks.pdf / Sapphire_Autonomy_and_Performance_Benchmarks.pdf
4. Beginners_Guide_Your_First_Autonomous_AI.pdf
5. Nexus_Language_Specification_and_Automation_Manual.pdf / Sapphire_Language_Specification_and_Automation_Manual.pdf
"""
...
def generate_pdf_manual(filename="Nexus_Language_Specification_and_Automation_Manual.pdf"):
    styles = setup_styles()
    doc = SimpleDocTemplate(filename, pagesize=letter, leftMargin=54, rightMargin=54, topMargin=54, bottomMargin=54)
    story = []
...
def main():
    ...
    # Generate into nexus_lang/ and docs/
    docs_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "docs"))
    os.makedirs(docs_dir, exist_ok=True)

    files_map = {
        "Nexus_Coding_and_Usage_Guide.pdf": generate_coding_guide,
        "Building_Advanced_Autonomous_AI.pdf": generate_advanced_ai_guide,
        "Nexus_Autonomy_and_Performance_Benchmarks.pdf": generate_benchmarks_pdf,
        "Beginners_Guide_Your_First_Autonomous_AI.pdf": generate_beginner_guide,
        "Nexus_Language_Specification_and_Automation_Manual.pdf": generate_pdf_manual
    }
