...
def generate_sample_files():
    ...
    output_path = os.path.join(CURRENT_DIR, "my_first_sapphire_bot.nx")
...
"""
    ...
    print("You can run this file anytime using: python sapphire_lang/src/cli.py run my_first_sapphire_bot.nx")
...
def main_menu():
    while True:
        ...
        print("4. 💾 Generate Sample 'my_first_sapphire_bot.nx' Script")
